...
```mermaid
flowchart LR
    A["<b>Fase 0: En Casa</b><br>Vídeo píldora (8 min): Ocio vs. Consumo<br>Test Moodle (3 preguntas)"] --> B["<b>Fase 1: El Gancho (15 min)</b><br>Noticia salario de reserva<br>Sondeo Mentimeter"]
    B --> C["<b>Fase 2: Mini-Lección (25 min)</b><br>Efecto Renta vs. Sustitución<br>Productividad marginal"]
    C --> D["<b>Fase 3: Laboratorio Activo (35 min)</b><br>Reto por parejas: Fijar el umbral<br>Debate de políticas públicas"]
    D --> E["<b>Fase 4: Cierre (15 min)</b><br>Pregunta tipo examen in situ<br>Conexión con Beveridge"]
```
