...
- **✅ Alerta 8 — Resuelta:** `guion_sesion_1409_martes.md` (Sesión 2) reescrito de raíz para PIB/Productividad (Epígrafe 2, Figuras 1.3-1.5); `guion_sesion_2109_martes.md` (Sesión 4) reescrito de raíz para Tipología+NAIRU/Phillips (Epígrafes 4-5, Figuras 1.6-1.8); `guion_sesion_2109_lunes.md` (Sesión 3) verificado sin cambios de contenido, solo corregidos el enlace al archivo canónico y la frase-puente hacia la Sesión 4. **Pendiente aparte:** la Sesión 5 (Beveridge completo, cierre de Tema 1) todavía no tiene guion — se abordará en la siguiente fase de trabajo (innovación docente).
