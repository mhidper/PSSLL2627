...
- La sesión de martes/viernes (Sesión 2, 120 min) se dedica al epígrafe 2 (El PIB y la Productividad en el Mercado Laboral) y es donde **arranca la dinámica docente de innovación** (gancho gamificado, mini-lección, laboratorio activo).
...
- Sesión 3 (lunes, 90 min): epígrafe 3/"Equilibrio en el mercado de trabajo" (oferta y demanda de trabajo, determinación de salarios, negociación colectiva — `guion_sesion_2109_lunes.md`, sigue válido sin cambios).
- Sesión 4 (martes/viernes, 120 min): epígrafe 4 (Tipología del desempleo) + epígrafe 5 (Tasa Natural de Desempleo/NAIRU y Curva de Phillips), en un único bloque de 120 min.
...
- **Sesión 5 de Tema 1** (primera sesión de la semana — M 29/09 en L1, 2 h; L 28/09 en L2, 1,5 h): epígrafe 6 completo (Curva de Beveridge: apartado nuevo 6.0 de dinámica de flujos $u^*=s/(s+f)$, 6.1 función de emparejamiento de Pissarides, 6.2 lectura gráfica, 6.3 eficiencia del emparejamiento, 6.4 caso español 2008-2016), como cierre y síntesis de Tema 1, con lanzamiento del Caso 1 de EPD. Cierra Tema 1 con 8 h netas en L1 / 7,5 h en L2 repartidas en 5 sesiones.
...
- **✅ Alerta 7 (resuelta con decisión del profesor):** al construir el material por sesión de Tema 1 se detectó que los epígrafes 2 y 5 no estaban asignados a ninguna sesión de las Semanas 1-2. Se resuelve añadiendo una 5ª sesión de Tema 1 que ocupa la que era la primera sesión de Tema 2 en la Semana 3. Efecto colateral: Tema 2 (I) pasa de 3,5 h a 1 sola sesión (1,5-2 h) — vigilar si "Introducción + Tipología de políticas activas" cabe con suficiente profundidad; las Semanas 4-5 de Tema 2 no se ven afectadas.
- **⚠️ Alerta 8 (nueva, pendiente):** al reordenar el docx de Tema 1 en secuencia estrictamente lineal (epígrafe 1→2→3→4+5→6, sin partir Beveridge), el reparto de contenido por sesión cambió respecto al que ya tenían escritos los guiones existentes: `guion_sesion_1409_martes.md` (Sesión 2) fue redactado para Tipología+Beveridge-intro y ahora esa sesión es PIB/Productividad; `guion_sesion_2109_martes.md` (Sesión 4) fue redactado para Beveridge-matching+caso español y ahora esa sesión es Tipología+NAIRU/Phillips. Ambos guiones necesitan reescritura. Además, la nueva Sesión 5 (Beveridge completo) no tiene guion todavía. Pendiente: preparar el prompt de ajuste para la otra IA (o decidir quién lo redacta).
